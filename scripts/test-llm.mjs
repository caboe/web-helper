...
check('OpenAI temperature', oaBody.temperature === 0.9, oaBody.temperature)
check('OpenAI top_p', oaBody.top_p === 0.92, oaBody.top_p)
check('OpenAI frequency_penalty', oaBody.frequency_penalty === 0.4, oaBody.frequency_penalty)
check('OpenAI presence_penalty', oaBody.presence_penalty === 0.4, oaBody.presence_penalty)
...
check('Anthropic temperature', anBody.temperature === 0.9, anBody.temperature)
check('Anthropic top_p', anBody.top_p === 0.92, anBody.top_p)
